  ...
  */
  ...
  conversationHandler() {
    ...
    for (let i = 0; i < steps.length; i++) {
      ...
      if (this.state[step.query] === undefined || step.query === undefined) {
        this.debug && console.log('conversationHandler: query requested ( ' + step.query +' )');
        ...
        const preModuleProcessingTopic = this.state.topic;
        ...
        // else -- recurse!
        if (preModuleProcessingTopic !== this.state.topic && typeof(query) !== 'undefined' ) {
