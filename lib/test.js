...
let testRespondCallback = function(state) {
  return state;
};
...
module.exports = {
  ...
  assertStatement: function(testPlan) {
    ...
    // go through each part of the flow until we run out of
    // response statements
